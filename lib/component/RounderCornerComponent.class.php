...
class RoundedCorner {
	...
	public function _get_lt_rounder_corner() {
		$radius = $this->_radius;
// 		include_once 'RounderCornerAntiComponent.class.php';
// 		$rounder = new RoundCornerAnti();
// 		return $rounder->outputImage('TL');
...
// 		var_dump(255);
	...
	public function round_it($dest_image = '') {
...
// 		header('Content-Type: image/png');
		$dest_image = $this->getDestImage($dest_image);
		imagepng($image, $dest_image);
	...
	private function getDestImage($dest_image = ''){
		if($dest_image == ''){
