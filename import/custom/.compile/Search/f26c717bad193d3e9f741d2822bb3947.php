		...
		<div class="entry">
			<div class="form">
				<form action="" method="get">
					<label>姓名:</label><input type="text" name="name" class="" value="<?=$name;?>"/>
					<label>性别:</label>
					<select name="gender">
						<option value="">不限</option>
						<option value="M" <?php if($gender == 'M'){?>selected="selected"<?php }?>>男</option>
						<option value="F" <?php if($gender == 'F'){?>selected="selected"<?php }?>>女</option>
					</select>
					<label>地址:</label><input type="text" name="address" class="" value="<?=$address;?>" />
